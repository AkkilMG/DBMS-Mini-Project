...
export const StepDetails: React.FC<StepOneProps>  = ({formData, setFormData}) => {
    return (
        <div className="w-full max-w-md">
            ...
            <form>
                <div className="mb-4">
                    ...
                    <input value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} className="w-full px-3 py-2 leading-tight text-gray-700 border rounded-lg shadow appearance-none h-14 focus:border-indigo-500 focus:shadow-lg focus:outline-none focus:ring-2" id="name" type="text" />
                </div>
                <div className="mb-6">
                    <span className="flex items-center justify-between mb-2 font-sans font-bold text-gray-700 text-sl">
                    Date of Incident
                    </span>
                    <input value={formData.DateIncident} onChange={(e) => setFormData({...formData, DateIncident: e.target.value})} className="w-full px-3 py-2 mb-3 leading-tight text-gray-700 border rounded-lg shadow appearance-none focus:border-indifo-500 h-14 focus:outline-none focus:ring" id="DateIncident" type="date" />
                </div>
                <div className="mb-6">
                    <span className="flex items-center justify-between mb-2 font-sans font-bold text-gray-700 text-sl">
